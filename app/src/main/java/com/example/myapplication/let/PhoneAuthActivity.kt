...
import com.example.myapplication.let.UserInfo.phoneAuthNum
import com.example.myapplication.let.UserInfo.tel
...
class PhoneAuthActivity : BaseActivity<ActivityPhoneAuthBinding>(R.layout.activity_phone_auth) {
    ...
    private val callbacks by lazy {
        object : PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            override fun onVerificationCompleted(credential: PhoneAuthCredential) {
                ...
                com.google.firebase.auth.UserInfo.phoneAuthNum = credential.smsCode.toString()
        ...
        binding.phoneAuthBtnAuth.run {
            ...
            setTextColor(
                ContextCompat.getColor(
                    this@PhoneAuthActivity, R.color.light_gray
                )
            )
            background = ContextCompat.getDrawable(
                this@PhoneAuthActivity, R.drawable.btn_light_gray_radius_4dp
            )
        }
    }
    ...
    private fun verifyPhoneNumberWithCode(phoneAuthCredential: PhoneAuthCredential) {
        com.google.firebase.auth.UserInfo.tel = binding.phoneAuthEtPhoneNum.text.toString()
        if (com.google.firebase.auth.UserInfo.tel.isNotBlank() && com.google.firebase.auth.UserInfo.phoneAuthNum.isNotBlank() &&
            (com.google.firebase.auth.UserInfo.tel == binding.phoneAuthEtPhoneNum.text.toString() && com.google.firebase.auth.UserInfo.phoneAuthNum == binding.phoneAuthEtAuthNum.text.toString())
            ...
            .addOnCompleteListener(this@PhoneAuthActivity) { task ->
                if (task.isSuccessful) {
                    ...
                    binding.phoneAuthTvAuthNum.setTextColor(
                        ContextCompat.getColor(this@PhoneAuthActivity, R.color.medium_red)
                    )
                    binding.phoneAuthEtAuthNum.isEnabled = true
                }
            }
